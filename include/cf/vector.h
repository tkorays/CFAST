...
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(int8_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(uint8_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(int16_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(uint16_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(int32_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(uint32_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(int64_t)
CF_VECTOR_DEFINE_PUSH_BACK_FUNC(uint64_t)

CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(char)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(int)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(int8_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(uint8_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(int16_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(uint16_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(int32_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(uint32_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(int64_t)
CF_VECTOR_DEFINE_PUSH_FRONT_FUNC(uint64_t)

CF_VECTOR_DEFINE_POP_BACK_FUNC(char)
CF_VECTOR_DEFINE_POP_BACK_FUNC(int)
CF_VECTOR_DEFINE_POP_BACK_FUNC(int8_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(uint8_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(int16_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(uint16_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(int32_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(uint32_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(int64_t)
CF_VECTOR_DEFINE_POP_BACK_FUNC(uint64_t)

CF_VECTOR_DEFINE_POP_FRONT_FUNC(char)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(int)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(int8_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(uint8_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(int16_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(uint16_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(int32_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(uint32_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(int64_t)
CF_VECTOR_DEFINE_POP_FRONT_FUNC(uint64_t)
